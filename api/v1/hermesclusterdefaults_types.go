...
// HermesClusterDefaultsSpec defines the desired state of HermesClusterDefaults
type HermesClusterDefaultsSpec struct {
	...
	// foo is an example field of HermesClusterDefaults. Edit hermesclusterdefaults_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// HermesClusterDefaultsStatus defines the observed state of HermesClusterDefaults.
type HermesClusterDefaultsStatus struct {
	...
	// conditions represent the current state of the HermesClusterDefaults resource.
